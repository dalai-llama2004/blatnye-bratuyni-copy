      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl md:text-6xl">
            Добро пожаловать в
            <span className="block text-primary-600">Коворкинг Братюни</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Современная система бронирования рабочих мест в коворкинге.
            Бронируйте места быстро и удобно.
          </p>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="card text-center">
              ...
              <p className="text-gray-600">
                Наши коворкинг-зоны расположены в удобных местах города
              </p>
            </div>
            <div className="card text-center">
              <div className="text-primary-600 text-4xl mb-4">⚡</div>
